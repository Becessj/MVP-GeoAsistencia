...
import 'package:asistencia-gpa/src/ui/constants/dashboard_info.dart';
import 'package:asistencia-gpa/src/ui/pages/perfil.dart'; 
import 'package:asistencia-gpa/src/ui/widgets/dashboard_tile.dart';
                ...
                switch (snapshot.connectionState) {
                  ...
                  case ConnectionState.done:
                    ...
                    return Stack(children: [
                      drawerTile("Ubicación asignada: ${snapshot.data}", () {},
                          Icons.location_on),
                    ]);
            ...
            FutureBuilder(
              ...
              builder: (context, snapshot) {
                switch (snapshot.connectionState) {
                  case ConnectionState.none:
                    return Text(
                      'Presione el botón para obtener los datos',
                      textAlign: TextAlign.center,
                    );
