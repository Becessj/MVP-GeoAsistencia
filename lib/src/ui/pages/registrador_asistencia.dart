...
import 'package:asistencia-gpa/src/services/marca_asistencia.dart';
import 'package:asistencia-gpa/src/services/obtener_oficinas.dart';
import 'package:asistencia-gpa/src/services/geofencing.dart';
import 'package:asistencia-gpa/src/ui/constants/colores.dart';
import 'package:asistencia-gpa/src/ui/widgets/botones_marcador_asistencia.dart';
...
class AttendanceRecorderWidgetState extends State<AttendanceRecorderWidget> {
  ...
  Widget googleMap(BuildContext context) {
    double _initialLat = -13.51818;
    double _initialLong = -71.96818;
  ...
  return Padding(
    ...
    child: Align(
      ...
      child: Row(
        children: <Widget>[
          Expanded(
            child: inOutButton("ENTRADA", Colors.green, _callMarkInFunction),
          ),
          SizedBox(width: 20), // espacio entre los botones
          Expanded(
            child: inOutButton("SALIDA", Colors.orangeAccent, _callMarkOutFunction),
          ),
        ],
      ),
    ),
